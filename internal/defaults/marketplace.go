...
const MarketplaceJSON = `{
  ...
  "plugins": [
    ...
    },
    {
      ...
      "commands": [
        {"use": "sys info", "operation": "system.info"}
      ]
    },
    {
      "name": "tavily",
      ...
      "commands": [
        {"use": "tavily search <query>", "operation": "tavily.search"}
      ]
    },
    {
      "name": "duckduckgo",
      ...
      "commands": [
        {"use": "ddg search <query>", "operation": "duckduckgo.search"}
      ]
    },
    {
      "name": "websearch",
      ...
      "binary": "",
      "commands": [
        {"use": "websearch providers", "operation": "websearch.provider.list"},
        {"use": "websearch search <query>", "operation": "websearch.search"}
      ],
