...
dex op run kubernetes.container.list '{"endpoint_ref":"dev-kubernetes","namespace":"latest"}'
...
dex op run kubernetes.container.show '{"endpoint_ref":"dev-kubernetes","namespace":"latest","name":"api-123/api"}'
