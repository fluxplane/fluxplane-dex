...
type ImageGenerateInput struct {
	...
	Size              string `json:"size,omitempty" jsonschema:"description=Image dimensions. Standard values include auto / 1024x1024 / 1536x1024 / 1024x1536 / 256x256 / 512x512 / 1792x1024 / 1024x1792. GPT image models also accept arbitrary WxH (divisible by 16; aspect between 1:3 and 3:1)."`
	Quality           string `json:"quality,omitempty" jsonschema:"description=Image quality. GPT image: low/medium/high/auto. dall-e-3: hd or standard. dall-e-2: standard only.,enum=auto,enum=high,enum=medium,enum=low,enum=hd,enum=standard"`
